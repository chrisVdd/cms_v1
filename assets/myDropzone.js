...
$(document).ready(function() {
    ...
    var $locationSelect = $('.js-post-form-location');
...
class ReferenceList
{
    ...
    render() {
        ...
        const itemsHtml = this.references.map(reference => {
            ...
            return `<li class="list-group-item d-flex justify-content-between align-items-center" data-id="${reference.id}">
                        <span class="drag-handle fas fa-reorder" style="width: 10px; height: 10px;"></span>
                        <input type="text" value="${reference.originalFilename}" class="form-control js-edit-filename" style="width: auto;">
                        
                        <span>
                            <a href="/admin/post/references/${reference.id}/download" class="btn btn-link btn-sm"><span class="fa fa-download" style="vertical-align: middle"></span></a>
